...
description: >-
  Remark-Plugin, clientseitiges CDN-Rendering, Platzhalter-Ersetzung in
...
Der Builder unterstützt [Mermaid](https://mermaid.js.org/)-Diagramme mit zweiphasiger Verarbeitung: Ein Remark-Plugin bereitet zur Build-Zeit das Markup vor, und ein clientseitiger Renderer erzeugt das SVG.
...
Mermaid wird bei Bedarf von einem CDN geladen — es ist nicht gebündelt:
...
2. Platzhalter-Ersetzung auf dem Quelltext ausführen (siehe unten)
...
## Platzhalter-Ersetzung in Diagrammen
...
Das Remark-Plugin konvertiert dies zur Build-Zeit in ein Container-Div. Der Client rendert es als SVG mit ersetzten Platzhalterwerten.
