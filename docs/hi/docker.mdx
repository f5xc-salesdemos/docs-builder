...
:::note
`astro.config.mjs` और `content.config.ts` थीम पैकेज से आते हैं और इस रिपो में वर्शन-कंट्रोल्ड नहीं हैं। डेव सर्वर चलाने से पहले आपको इन्हें `node_modules` से कॉपी करना होगा। Docker बिल्ड में एंट्रीपॉइंट यह स्वचालित रूप से हैंडल करता है।
:::

:::note
`src/content/docs/` इमेज बिल्ड समय पर खाली कर दिया जाता है और gitignore किया जाता है। वहाँ मैन्युअल रूप से टेस्ट कंटेंट रखें — यह कमिट नहीं होगा।
:::
